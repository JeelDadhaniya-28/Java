                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="car.jsp" class="dropdown-item">All Cars</a>
                                <a href="detail.jsp" class="dropdown-item">Car Detail</a>
                                <a href="car-single.jsp" class="dropdown-item">Car Booking</a>
                            </div>
                        </div>
...
<%-- <%
	if(request.getRequestDispatcher("login.jsp") || request.getRequestDispatcher("signup.jsp") || request.getRequestDispatcher("changepassword.jsp")){
