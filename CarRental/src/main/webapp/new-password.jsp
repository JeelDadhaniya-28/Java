                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form name="frm" method="post" action="UserSignUpController">
                            <div class="row">
                                ...
                                <input type="hidden" name="email_id" value="<%=request.getAttribute("email") %>">
                            ...
                            <div>
                                <button class="btn btn-primary py-3 px-5" type="submit" value="updatepassword" name="action">Change Password</button>
                            </div>
                        </form>
                    </div>
                </div>
